...
def show_entry():
        num1 = (eingabe1.get())  
        ausgabe = Liter-int(num1)
        
        if(ausgabe > 0):
           wasser = Label(tkFenster, text="Du musst noch\n%d" % ausgabe + " Liter trinken")
        
        else:
            wasser = Label(tkFenster, text="Du musst heute \nkeine Wasser\nmehr trinken")
        wasser.place(x=110, y= 130)
...
#Delete Button
Button(tkFenster, text="Delete", command=remove).place(x=130, y=70)
#Ausrechnen
